      ...
      <div className="relative z-10 w-full max-w-md animate-pop">
        ...
        <div className="card p-8">
          ...
          <p className="text-gray-400 text-sm text-center mb-8">
            Pumili ng paraan para mag-login
          </p>
          ...
          <div className="space-y-3">
            ...
            >
              ...
              {loadingProvider === 'google' ? 'Naglo-login...' : 'Mag-login gamit ang Google'}
            </button>
            ...
            >
              ...
              {loadingProvider === 'facebook' ? 'Naglo-login...' : 'Mag-login gamit ang Facebook'}
            </button>
          </div>
